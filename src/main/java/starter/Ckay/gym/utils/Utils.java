package starter.Ckay.gym.utils;
...
public class Utils {
    public static void saveResource(PlasmaGym plugin, String resourcePath, boolean replace) {
        if (resourcePath == null || resourcePath.equals("")) {
            throw new IllegalArgumentException("ResourcePath cannot be null or empty");
        }

        resourcePath = resourcePath.replace('\\', '/');
        InputStream in = PlasmaGym.class.getClassLoader().getResourceAsStream(resourcePath);
