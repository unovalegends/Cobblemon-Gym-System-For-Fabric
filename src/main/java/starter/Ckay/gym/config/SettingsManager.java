...
public class SettingsManager {
    ...
    // Badges
    public void setupBadges(PlasmaGym p) {
    ...
    // Log
    public void setupLog(PlasmaGym p) {
    ...
    // Extras
    public void setupExtra(PlasmaGym p) {
    ...
    // Signs
    public void setupSigns(PlasmaGym p) {
