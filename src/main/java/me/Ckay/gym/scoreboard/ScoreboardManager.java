...
public class ScoreboardManager {
    ...
    private void init() {
        ...
        gym1 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym1colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym1")));

        gym2 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym2colour") + "TEXT").getColor()
                , plugin.getConfig().getString("config.gym2") + " "));

        gym3 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym3colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym3")));
        gym4 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym4colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym4")));
        gym5 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym5colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym5")));
        gym6 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym6colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym6") + " "));
        gym7 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym7colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym7")));
        gym8 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym8colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym8")));
        gym9 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym9colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym9")));
        gym10 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym10colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym10")));
        gym11 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym11colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym11")));
        gym12 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym12colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym12")));
        gym13 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym13colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym13")));
        gym14 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym14colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym14")));
        gym15 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym15colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym15")));
        gym16 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym16colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym16")));
        gym17 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym17colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym17")));
        gym18 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym18colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym18")));
        gym19 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym19colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym19")));
        gym20 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym20colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym20")));
        gym21 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym21colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym21")));
        gym22 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym22colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym22")));
        gym23 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym23colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym23")));
        gym24 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym24colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym24")));
        gym25 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym25colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym25")));
        gym26 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym26colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym26")));
        gym27 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym27colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym27")));
        gym28 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym28colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym28")));
        gym29 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym29colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym29")));
        gym30 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym30colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym30")));
        gym31 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym31colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym31")));
        gym32 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.gym32colour") + "TEXT").getColor(), plugin.getConfig().getString("config.gym32")));

        e41 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.e41colour") + "TEXT").getColor(), plugin.getConfig().getString("config.e41") + " " + plugin.getConfig().getString("config.e4ab")));
        e42 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.e42colour") + "TEXT").getColor(), plugin.getConfig().getString("config.e42") + " " + plugin.getConfig().getString("config.e4ab")));
        e43 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.e43colour") + "TEXT").getColor(), plugin.getConfig().getString("config.e43") + " " + plugin.getConfig().getString("config.e4ab")));
        e44 = obj.getOrCreateScore(Text.of(TextSerializers.FORMATTING_CODE.deserialize(plugin.getConfig().getString("config.e44colour") + "TEXT").getColor(), plugin.getConfig().getString("config.e44") + " " + plugin.getConfig().getString("config.e4ab")));
