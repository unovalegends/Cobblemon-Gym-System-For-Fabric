            ...
            if ((args[0].equalsIgnoreCase("scoreboard")) && (this.plugin.getConfig().getString("config.scoreboard").equals("True"))) {
                            ...
                            if (!staff.hasPermission("*")) {
                                ...
                                for (int i = 1; i <= 32; i++) {
                                    if ((staff.hasPermission("pixelgym.gym" + i)) && (this.plugin.getConfig().getString("config.gym" + i + "enabled").equalsIgnoreCase("true"))) {
                                        p.sendMessage(Text.of(TextColors.GREEN, staff.getName(), TextColors.BLACK, " - ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString(new StringBuilder("config.gym").append(i).append("colour").toString()) + "TEXT").getColor(), TextStyles.BOLD, getConfig().getString(new StringBuilder("config.gym").append(i).toString()) + " Gym"));
                                        // p.sendMessage(Text.of(TextColors.GREEN, "This is Green", TextSerializers.FORMATTING_CODE.deserialize("&4"+"TEXT").getColor(), " This is Red"));
                                    }
                                }
                            }
                        }
                ...
                for (int i = 1; i <= 32; i++) {
                    if (this.plugin.getConfig().getString("config.gym" + i + "enabled").equalsIgnoreCase("true")) {
                        ...
                        p.sendMessage(Text.of(TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString(new StringBuilder("config.gym").append(i).append("colour").toString()) + "TEXT").getColor(), TextStyles.BOLD, getConfig().getString(new StringBuilder("config.gym").append(i).toString()) + " Gym is: ", TextColors.DARK_GREEN, getConfig().getString(new StringBuilder("config.gym").append(i).append("stat").toString()), TextColors.BLUE, " - " + "Level Cap = " + getConfig().getString(new StringBuilder("config.gym").append(i).append("lvlcap").toString())));
                    }
                    ...
                    if (!((Map) this.plugin.cooldownTime.get(Integer.valueOf(gym))).containsKey(o)) {
                        if (this.plugin.settings.getBadge().get("Players." + p.getUniqueId() + ".Badges.gym" + gym) != null) {
                            ...
                            if (((List) this.plugin.queues.get(Integer.valueOf(gym))).contains(p.getUniqueId())) {
                                ...
                                p.sendMessage(Text.of(TextColors.GREEN, "Added to queue: ", TextColors.YELLOW, TextStyles.BOLD, gym, TextColors.BLACK, " (", TextSerializers.FORMATTING_CODE.deserialize(String.valueOf(this.plugin.getConfig().getString("config.gym" + gym + "colour")) + "TEXT").getColor(), TextStyles.BOLD, this.plugin.getConfig().getString("config.gym1"), TextColors.BLACK, ")"));
                                ...
                                p.sendMessage(Text.of(TextColors.GREEN, "Notified gym leaders of gym1", TextColors.BLACK, " (", TextSerializers.FORMATTING_CODE.deserialize(this.plugin.getConfig().getString("config.gym" + gym + "colour") + "TEXT").getColor(), TextStyles.BOLD, this.plugin.getConfig().getString("config.gym1"), TextColors.BLACK, ")", TextColors.GREEN, " that you are waiting to be battled!"));
                                ...
                                for (Player leader : Sponge.getServer().getOnlinePlayers()) {
                                    if (leader.hasPermission("pixelgym.gym" + gym)) {
                                        leader.sendMessage(Text.of(TextColors.BLUE, "A challenger has joined queue ", TextColors.YELLOW, TextStyles.BOLD, gym, TextColors.BLACK, " (", TextSerializers.FORMATTING_CODE.deserialize(new StringBuilder(this.plugin.getConfig().getString(new StringBuilder("config.gym")
                                                .append(gym).append("colour").toString())).toString() + "TEXT").getColor(), TextStyles.BOLD, this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).toString()), TextColors.BLACK, ")", TextColors.GOLD, " (" + p.getName() + ")"));
                            ...
                            while (playerToTeleport == null) {
                                if (!this.plugin.queues.get(Integer.valueOf(gym)).isEmpty()) {
                                    ...
                                    p.sendMessage(Text.of(TextColors.GREEN, "Getting first player from queue ", TextColors.GOLD, " (" + playerToTeleport.getName() + ")", TextColors.YELLOW, TextStyles.BOLD, gym, TextColors.BLACK, " (", TextSerializers.FORMATTING_CODE.deserialize(new StringBuilder(this.plugin.getConfig().getString(new StringBuilder("config.gym")
                                            .append(gym).append("colour").toString())).toString() + "TEXT").getColor(), TextStyles.BOLD, this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).toString()), TextColors.BLACK, ")"));
                            ...
                            if (this.plugin.getConfig().getString("config.gymfee").equalsIgnoreCase("True")) {
                                ...
                                if (account.getBalance(this.plugin.getEconomy().getDefaultCurrency()).doubleValue() >= fee) {
                                    ...
                                    playerToTeleport.sendMessage(Text.of(TextColors.GREEN, "Welcome to ", TextSerializers.FORMATTING_CODE.deserialize(new StringBuilder(String.valueOf(this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym)
                                            .append("colour").toString()))).toString() + "TEXT").getColor(), TextStyles.BOLD, this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).toString()), " Gym!"));
                                ...
                                if (this.plugin.getConfig().getString("config.gym" + gym + "stat").equals("Open")) {
                                    ...
                                    if (this.plugin.getConfig().getString("config.gym" + gym + "enabled").equalsIgnoreCase("True")) {
                                        MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString(new StringBuilder("config.gym")
                                                .append(gym).append("colour").toString()) + "TEXT").getColor(), "The " + getConfig().getString(new StringBuilder("config.gym").append(gym).toString()) + " Gym is now ", TextColors.GREEN, "Open"));
                            ...
                            if ((p.hasPermission("pixelgym.gym" + gym)) || (p.hasPermission("pixelgym.admin"))) {
                                ...
                                if (this.plugin.getConfig().getString("config.gym" + gym + "enabled").equalsIgnoreCase("True")) {
                                    if (this.plugin.getConfig().getString("config.gym" + gym + "stat").equals("Closed")) {
                                        ...
                                        MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString(new StringBuilder("config.gym")
                                                .append(gym).append("colour").toString()) + "TEXT").getColor(), "The " + getConfig().getString(new StringBuilder("config.gym").append(gym).toString()) + " Gym is now ", TextColors.RED, "Closed"));
    ...
    private void handleE4(Player p, String[] args) throws MalformedURLException {
        if (args.length == 0) {
            ...
            if (args[0].equals("leaders")) {
                ...
                p.sendMessage(Text.of(""));
                if (this.plugin.enablee4.equalsIgnoreCase("true")) {
                    p.sendMessage(Text.of(TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e41colour") + "TEXT").getColor() + getConfig().getString("config.e41") + "  Elite 4 is: ", TextColors.BLUE, getConfig().getString("config.e41stat")));
                    p.sendMessage(Text.of(TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e42colour") + "TEXT").getColor() + getConfig().getString("config.e42") + "  Elite 4 is: ", TextColors.BLUE, getConfig().getString("config.e42stat")));
                    p.sendMessage(Text.of(TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e43colour") + "TEXT").getColor() + getConfig().getString("config.e43") + "  Elite 4 is: ", TextColors.BLUE, getConfig().getString("config.e43stat")));
                    p.sendMessage(Text.of(TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e44colour") + "TEXT").getColor() + getConfig().getString("config.e44") + "  Elite 4 is: ", TextColors.BLUE, getConfig().getString("config.e41stat")));
                }
            ...
            if (p.hasPermission("pixelgym.e4leader")) {
                if ((args[0].equalsIgnoreCase("open")) && (args[1].equalsIgnoreCase("e41")) && (p.hasPermission("pixelgym.e41")) && (this.plugin.enablee4.equalsIgnoreCase("true"))) {
                    MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e41colour") + "TEXT").getColor(), "The " + getConfig().getString("config.e41") + " " + getConfig().getString("config.e4") + " is now ", TextColors.GREEN, "Open"));
                ...
                if ((args[0].equalsIgnoreCase("open")) && (args[1].equalsIgnoreCase("e43")) && (p.hasPermission("pixelgym.e43")) && (this.plugin.enablee4.equalsIgnoreCase("true"))) {
                    MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e43colour") + "TEXT").getColor(), "The " + getConfig().getString("config.e43") + " " + getConfig().getString("config.e4") + " is now ", TextColors.GREEN, "Open"));
                ...
                if ((args[0].equalsIgnoreCase("open")) && (args[1].equalsIgnoreCase("e44")) && (p.hasPermission("pixelgym.e44")) && (this.plugin.enablee4.equalsIgnoreCase("true"))) {
                    MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e44colour") + "TEXT").getColor(), "The " + getConfig().getString("config.e44") + " " + getConfig().getString("config.e4") + " is now ", TextColors.GREEN, "Open"));
                    ...
                    MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e41colour") + "TEXT").getColor(), "The " + getConfig().getString("config.e41") + " " + getConfig().getString("config.e4") + " is now ", TextColors.RED, "Closed"));
                    getConfig().set("config.e41stat", "Closed");
                    URL myURL = new URL("https://forums.spongepowered.org/t/pixelmongym-pixelmonmod-gym-management/17875");
                    Text link = Text.builder("Click here to find the plugin page!").onClick(TextActions.openUrl(myURL)).build();
                    ...
                    MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e42colour") + "TEXT").getColor(), "The " + getConfig().getString("config.e42") + " " + getConfig().getString("config.e4") + " is now ", TextColors.RED, "Closed"));
                    getConfig().set("config.e42stat", "Closed");
                    URL myURL = new URL("https://forums.spongepowered.org/t/pixelmongym-pixelmonmod-gym-management/17875");
                    Text link = Text.builder("Click here to find the plugin page!").onClick(TextActions.openUrl(myURL)).build();
                    ...
                    MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e43colour") + "TEXT").getColor(), "The " + getConfig().getString("config.e43") + " " + getConfig().getString("config.e4") + " is now ", TextColors.RED, "Closed"));
                    getConfig().set("config.e43stat", "Closed");
                    URL myURL = new URL("https://forums.spongepowered.org/t/pixelmongym-pixelmonmod-gym-management/17875");
                    Text link = Text.builder("Click here to find the plugin page!").onClick(TextActions.openUrl(myURL)).build();
                    ...
                    MessageChannel.TO_ALL.send(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(getConfig().getString("config.e44colour") + "TEXT").getColor(), "The " + getConfig().getString("config.e44") + " " + getConfig().getString("config.e4") + " is now ", TextColors.RED, "Closed"));
                    getConfig().set("config.e44stat", "Closed");
                    URL myURL = new URL("https://forums.spongepowered.org/t/pixelmongym-pixelmonmod-gym-management/17875");
                    Text link = Text.builder("Click here to find the plugin page!").onClick(TextActions.openUrl(myURL)).build();
