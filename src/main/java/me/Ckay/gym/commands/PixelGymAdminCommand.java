                ...
                if (args[1].matches("(gym|GYM)[1-9]?[0-9]") || gymName == true) {
                    ...
                    if (p.hasPermission("pixelgym.admin")) {
                        if (Sponge.getServer().getPlayer(args[2]).orElse(null) != null) {
                            ...
                            playerTarget.sendMessage(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, this.plugin.getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).append("colour").toString()) + "TEXT").getColor(), "You have been set as a " + this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).toString()) + " Leader!"));
                            playerTarget.sendMessage(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, this.plugin.getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).append("colour").toString()) + "TEXT").getColor(), "Try /gym or /e4 to see your new commands!"));
                            p.sendMessage(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, this.plugin.getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(this.plugin.getConfig().getString(new StringBuilder("config.gym")
                                    .append(gym).append("colour").toString()) + "TEXT").getColor(), playerTarget.getName().toString() + " has successfully been added as a " + this.plugin.getConfig().getString(new StringBuilder("config.").append(args[1]).toString()) + " leader!"));
                ...
                if (args[1].matches("(gym|GYM)[1-9]?[0-9]") || args[1].equalsIgnoreCase("all") || gymName == true) {
                    ...
                    if (p.hasPermission("pixelgym.admin")) {
                        if (args[2].equals(playerTarget.getName())) {
                            ...
                            if (args[1].equalsIgnoreCase("all")) {
                                ...
                                p.sendMessage(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, this.plugin.getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).append("colour").toString()) + "TEXT").getColor(), playerTarget.getName().toString() + " has successfully been removed as a " + this.plugin.getConfig().getString(new StringBuilder("config.gym").append(gym).toString()) + " leader!"));
                    ...
                    if (args[1].equalsIgnoreCase("all")) {
                        ...
                        p.sendMessage(Text.of(TextColors.DARK_GRAY, "[", TextColors.AQUA, this.plugin.getConfig().getString("config.title"), TextColors.DARK_GRAY, "] ", TextSerializers.FORMATTING_CODE.deserialize(this.plugin.getConfig().getString(new StringBuilder("config.").append(args[1])
                                .append("colour").toString()) + "TEXT").getColor(), playerTarget.getName().toString() + " has successfully been removed as a " + this.plugin.getConfig().getString(new StringBuilder("config.").append(args[1]).toString()) + " leader!"));
                    }
                } else {
                    p.sendMessage(Text.of(TextColors.RED, "Gym " + args[1] + " is not a valid gym."));
                }
